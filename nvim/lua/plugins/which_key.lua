...
which_key.register(buffer_maps, {
    prefix = "<leader>"
})
...
if is_plugin_installed("telescope.nvim") or is_plugin_installed("onedark.nvim") then
    ...
    which_key.register(colorscheme_maps, {
        prefix = "<leader>"
    })
end
...
if is_plugin_installed("toggleterm.nvim") then
    ...
    which_key.register(terminal_maps, {
        prefix = "<leader>"
    })
end
